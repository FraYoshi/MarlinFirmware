...
// REFERENCES
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5/MKS Robin E3D/V1.1/TMC2209" 
//#define CONFIG_EXAMPLES_DIR "Creality/Ender-3/MKS Robin E3/V1.1" // reference
// https://github.com/makerbase-mks/MKS-Robin-E3-E3D/tree/master/firmware/V1.1/Marlin-2.0.6.1_for_ender5_TMC2209/Marlin
/**
 * Configuration.h
 *
...
#define STRING_CONFIG_H_AUTHOR "(Francesco Yoshi Gobbo, Ender-5-Pro)" // based on thisiskeithb, Ender-3 //Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-5
    ...
    #define DEFAULT_Kp_LIST {  23.04,  23.04 }
    #define DEFAULT_Ki_LIST {   1.42,   1.42 }
    #define DEFAULT_Kd_LIST {  93.53,  93.53 }
  #else
    #define DEFAULT_Kp  23.04
    #define DEFAULT_Ki   1.42
    #define DEFAULT_Kd  93.53
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 193.91
  #define DEFAULT_bedKi 37.87
  #define DEFAULT_bedKd 661.88
